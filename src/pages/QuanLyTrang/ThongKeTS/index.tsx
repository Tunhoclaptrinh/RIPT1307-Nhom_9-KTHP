	...
	const columns: IColumn<ThongKeTS.IRecord>[] = [
		{
			...
			filterType: 'number',
			align: 'center',
			render: (year: number) => <div style={{ fontWeight: 500, color: '#1890ff' }}>{year}</div>,
		},
		{
			title: 'Số trường ĐH',
			...
			filterType: 'number',
			align: 'center',
			render: (value: number) => <Statistic value={value} valueStyle={{ fontSize: '14px', color: '#52c41a' }} />,
		},
		{
			...
			filterType: 'number',
			align: 'center',
			render: (value: number) => <Statistic value={value} valueStyle={{ fontSize: '14px', color: '#1890ff' }} />,
		},
		{
			...
			filterType: 'number',
			align: 'center',
			render: (value: number) => <Statistic value={value} valueStyle={{ fontSize: '14px', color: '#722ed1' }} />,
		},
		{
		...
		},
		{
			...
			filterType: 'date',
			align: 'center',
			render: (date: string) => <div style={{ color: '#666' }}>{moment(date, 'DD/MM/YYYY').format('DD/MM/YYYY')}</div>,
		},
		{
			title: 'Thao tác',
			align: 'center',
