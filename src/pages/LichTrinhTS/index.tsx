...
import { DeleteOutlined, EditOutlined, EyeOutlined, CalendarOutlined, CheckCircleOutlined, UserOutlined } from '@ant-design/icons';
...
const LichTrinhTSPage = () => {
    ...
    const getTypeColor = (type: string) => {
        switch (type) {
            case 'dangky': return 'blue';
            case 'ketqua': return 'green';
            case 'nhaphoc': return 'purple';
    ...
    const getTypeText = (type: string) => {
        switch (type) {
            ...
            case 'ketqua': return 'Kết quả';
            case 'nhaphoc': return 'Nhập học';
            default: return type;
        }
    };
    ...
    const getTypeIcon = (type: string) => {
        switch (type) {
            case 'dangky': return <CalendarOutlined />;
            case 'ketqua': return <CheckCircleOutlined />;
            case 'nhaphoc': return <UserOutlined />;
