...
// Extract SVG icons to separate components for better maintainability
const FacebookIcon = () => (
...
const LocationIcon = () => (
	<svg className='icon' xmlns='http://www.w3.org/2000/svg' fill='currentColor' viewBox='0 0 16 20'>
...
const PhoneIcon = () => (
	<svg className='icon' xmlns='http://www.w3.org/2000/svg' fill='currentColor' viewBox='0 0 19 19'>
...
const EmailIcon = () => (
	<svg className='icon' xmlns='http://www.w3.org/2000/svg' fill='currentColor' viewBox='0 0 20 16'>
...
// Create address component for reusability
...
// Create about us link component
const AboutUsLink = ({ text }: any) => <p className='about-us-link'>{text}</p>;
...
const Footer = () => {
	const addresses = [
		...
		},
		{
			...
			address: '11 Nguyễn Đình Chiểu, P. Đa Kao, Q.1 TP Hồ Chí Minh',
		},
		{
		...
		},
		{
			...
			address: 'Đường Man Thiện, P. Hiệp Phú, Q.9 TP Hồ Chí Minh',
		},
	];

	const aboutUsLinks = ['Giới thiệu', 'Thông báo', 'Đề án tuyển sinh', 'Tra cứu tuyển sinh'];

	return (
		<Row justify='center'>
			<Col xs={24} lg={20}>
				<footer aria-label='Footer' className='box-wrapper'>
					<div className='container'>
							...
							<Col xs={24} md={8} lg={6}>
								<div className='social-icons-row' aria-label='Social Media Links'>
									<a
										...
										href='https://www.facebook.com/HocvienCongngheButchinh/'
										target='_blank'
										rel='noreferrer'
										aria-label='Facebook'
									>
									...
									<a
										className='social-icon'
										href='https://www.youtube.com/channel/UC0UewdQzwwBhCbMHJJQ0wXw'
										target='_blank'
										rel='noreferrer'
										aria-label='YouTube'
									>
									...
									<a
										className='social-icon'
										href='https://www.tiktok.com/@ptit.edu.vn'
										target='_blank'
										rel='noreferrer'
										aria-label='TikTok'
									>
						...
						<Row gutter={[16, 32]}>
							...
							<Col xs={24} md={12}>
								<div className='address'>
									{addresses.map((item, index) => (
										<AddressBlock key={`address-${index}`} title={item.title} address={item.address} />
									))}
								</div>
							...
							{/* Google Map */}
							<Col xs={24} md={8} className='map-wrapper'>
								<iframe
									...
									allowFullScreen
									loading='lazy'
									title='Học viện Công nghệ Bưu chính Viễn thông Google Map Location'
							...
							<Col xs={24} sm={12} md={4}>
								<div className='social-media'>
									...
									{aboutUsLinks.map((link, index) => (
										<AboutUsLink key={`about-us-${index}`} text={link} />
									))}
								</div>
							</Col>
						</Row>
						...
						<div className='footer'>
							<a className='link' href='https://ptit.edu.vn/' target='_blank' rel='noreferrer'>
								<b>
									© Copyright 2024 HocVienCongNgheBuuChinhVienThong, All rights reserved ® Học viện Công nghệ Bưu chính
									Viễn thông giữ bản quyền nội dung trên website này
								</b>
							</a>
						</div>
					</div>
